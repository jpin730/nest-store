...
export class RelationProductCategory1705964890051
  implements MigrationInterface
{
  name = 'RelationProductCategory1705964890051'

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "product_categories_category" ("productId" uuid NOT NULL, "categoryId" uuid NOT NULL, CONSTRAINT "PK_17f2a361443184000ee8d79f240" PRIMARY KEY ("productId", "categoryId"))`,
    )
    await queryRunner.query(
